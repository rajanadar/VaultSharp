...
VaultSharp is built on **.NET Standard 1.3** & **.NET Standard 2.0** & **.NET Standard 2.1**  & **.NET Frameworks 4.5, 4.6.x, 4.7.x, 4.8** & **.NET 5**. This makes it highly compatible and cross-platform.
