...
- VaultSharp is a .NET 7.0 based cross-platform C# Library that can be used in any .NET application to interact with Hashicorp's Vault.
...
VaultSharp is built on .NET 7**. This makes it highly compatible and cross-platform.
