...
{
    /// <summary>
    /// Converts the <see cref="SSHCredentials" /> object from JSON.
    /// </summary>
    public class SSHCredentialsJsonConverter : JsonConverter
    {
        /// <summary>
        ...
        {
            return objectType == typeof (SSHCredentials);
        }
    }
}