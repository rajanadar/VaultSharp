...
namespace VaultSharp.V1.AuthMethods.AppRole
{
    ...
    public class AppRoleAuthMethodInfo : IAuthMethodInfo
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="AppRoleAuthMethodInfo"/> class.
        /// </summary>
        /// <param name="roleId">
        /// The role identifier.
        /// RoleID is an identifier that selects the AppRole against which the other credentials are evaluated. 
        ...
        /// TTLs and expirations.
        /// </param>
        public AppRoleAuthMethodInfo(string roleId, string secretId = null) : this(AuthMethodType.AppRole.Type, roleId, secretId)
        {
        }
        ...
        /// TTLs and expirations.
        /// </param>
        public AppRoleAuthMethodInfo(string mountPoint, string roleId, string secretId = null)
        {
