...
public class UserPassUser
{
    /// <summary>
    ///     The username for the user.Accepted characters:
    ///     alphanumeric plus "_", "-", "." (underscore, hyphen and period);
    ///     username cannot begin with a hyphen, nor can it begin or end with a period.
    /// </summary>
