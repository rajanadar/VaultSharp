...
namespace VaultSharp.V1.SecretsEngines.RabbitMQ
{
    ...
    public interface IRabbitMQSecretsEngine
    {
        ...
        /// </returns>
        Task<Secret<UsernamePasswordCredentials>> GenerateCredentialsAsync(string roleName, string mountPoint = SecretsEngineDefaultPaths.RabbitMQ, string wrapTimeToLive = null);
    }
}