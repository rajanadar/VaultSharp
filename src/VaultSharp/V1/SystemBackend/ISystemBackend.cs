...
namespace VaultSharp.V1.SystemBackend
{
    ...
    public interface ISystemBackend
    {
        ...
        /// <param name="path">
        ///     <para>[required]</para>
        ///     The mount point for the audit backend. (with or without trailing slashes. it doesn't matter)
        /// </param>
        /// <returns>
        ///     The task.
        /// </returns>
        ...
        /// <param name="path">
        ///     <para>[required]</para>
        ///     The authentication path for the authentication backend. (with or without trailing slashes. it doesn't matter)
        /// </param>
        /// <returns>
        ///     The task.
        /// </returns>
        ...
        ///     (with or without trailing slashes. it doesn't matter)
        /// </param>
        /// <returns>
        ...
        ///     The authentication path for the authentication backend. (with or without trailing slashes. it doesn't matter)
        /// </param>
        /// <param name="backendConfig">
        ///     <para>[required]</para>
        ///     The mount configuration with the required setting values.
        ///     Provide a value of
        ///     <value>"0"</value>
        ///     for the TTL settings if you want to use the system defaults.
        /// </param>
        /// <returns>
        ///     A task
        /// </returns>
        ...
        ///     <para>[required]</para>
        ///     Accessor to the Token for which capabilities are being queried.
        /// </param>
        /// <returns>The list of capabilities.</returns>
        ...
        /// </summary>
        /// <param name="base64EncodedOneTimePassword">
        ///     <para>[optional]</para>
        ///     A base64-encoded 16-byte value. The raw bytes of the token will be XOR'd with this
        ///     value before being returned to the final unseal key provider.
        /// </param>
        /// <param name="pgpKey">
        ///     <para>[optional]</para>
        ...
        Task<RootTokenGenerationStatus> InitiateRootTokenGenerationAsync(string base64EncodedOneTimePassword,
            string pgpKey);
        ...
        /// </summary>
        /// <param name="masterShareKey">
        ///     <para>[required]</para>
        ///     A single master share key.
        /// </param>
        /// <param name="nonce">
        ///     <para>[required]</para>
        ///     The nonce of the root generation attempt.
        /// </param>
        /// <returns>
        ...
        ///     DEFAULTs to
        ///     <value>200</value>
        ///     , meaning the default HTTP 200 Status code will be returned.
        /// </param>
        /// <param name="standbyStatusCode">
        ///     <para>[optional]</para>
        ///     A user defined status code provided to indicate the status code that should be returned
        ///     for an standby node instead of the default error response of HTTP 429.
        ///     DEFAULTs to
        ///     <value>429</value>
        ///     , meaning the default HTTP 429 Status code will be returned.
        /// </param>
        /// <param name="sealedStatusCode">
        ///     <para>[optional]</para>
        ///     A user defined status code provided to indicate the status code that should be returned
        ///     for an sealed node instead of the default error response of HTTP 503.
        ///     DEFAULTs to
        ///     <value>503</value>
        ///     , meaning the default HTTP 503 Status code will be returned.
        /// </param>
        /// <param name="uninitializedStatusCode">
        ///     <para>[optional]</para>
        ///     A user defined status code provided to indicate the status code that should be returned
        ///     for an uninitialized vault node instead of the default error response of HTTP 501.
        ///     DEFAULTs to
        ///     <value>501</value>
        ///     , meaning the default HTTP 501 Status code will be returned.
        /// </param>
        /// <param name="queryHttpMethod">
        ///     <para>[optional]</para>
        ...
        ///     The health status.
        /// </returns>
        Task<HealthStatus> GetHealthStatusAsync(bool standbyOk = false, int activeStatusCode = (int) HttpStatusCode.OK,
            int standbyStatusCode = 429, int sealedStatusCode = (int) HttpStatusCode.ServiceUnavailable,
        ...
        /// <summary>
        ///     Revokes revokes all secrets (via a lease ID prefix) or tokens (via the tokens' path property) generated under a
        ...
        /// <param name="path">
        ///     <para>[required]</para>
        ///     The mount point for the secret backend. (with or without trailing slashes. it doesn't matter)
        /// </param>
        /// <returns>
        ///     A task
        /// </returns>
        ...
        ///     Provide a value of
        ///     <value>0</value>
        ///     for the TTL settings
        ///     if you want to use the system defaults.
        /// </param>
        /// <returns>
        ///     A task
        /// </returns>
        ...
        /// <param name="policy">
        ///     <para>[required]</para>
        ///     The policy to be added or updated.
        /// </param>
        /// <returns>
        ///     The task.
        /// </returns>
        ...
        /// </summary>
        /// <param name="storagePathPrefix">
        ///     <para>[required]</para>
        ///     Raw path in the storage backend and not the logical path that is exposed via the mount system.
        /// </param>
        ...
        /// <param name="values">
        ///     <para>[required]</para>
        ///     The values to write. The dictionary will be JSONized as a raw value string before being written.
        /// </param>
        /// <returns>
        ///     The task.
        /// </returns>
        ...
        ///     Only a single rekey attempt can take place at a time, and changing the parameters of a rekey requires canceling and
        ///     starting a new rekey.
        ///     This is an unauthenticated call and does not need credentials.
        /// </summary>
        /// <param name="secretShares">
        ///     <para>[required]</para>
        ///     The number of shares to split the master key into.
        /// </param>
        /// <param name="secretThreshold">
        ///     <para>[required]</para>
        ///     The number of shares required to reconstruct the master key.
        ///     This must be less than or equal to <see paramref="secretShares" />.
        /// </param>
        /// <param name="pgpKeys">
        ///     <para>[optional]</para>
        ...
        ///     The size of this array must be the same as <see paramref="secretShares" />.
        /// </param>
        /// <param name="backup">
        ///     <para>[optional]</para>
        ...
        ///     The rekey status.
        /// </returns>
        Task<RekeyStatus> InitiateRekeyAsync(int secretShares, int secretThreshold, string[] pgpKeys = null,
            bool backup = false);
        ...
        /// <param name="resetCompletely">
        ///     When
        ///     <value>true</value>
        ///     , the previously-provided unseal keys are discarded from memory
        ///     and the unseal process is completely reset.
        ///     Default value is
        ///     <value>false</value>
        ///     .
        ///     If you make a call with the value as
        ///     <value>true</value>
        ///     , it doesn't matter if this call has a valid unused <see paramref="masterShareKey" />.
        ///     It'll be ignored.
        /// </param>
        /// <returns>
        ///     The seal status of the Vault.
